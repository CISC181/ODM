...
namespace OracleDataMoverOraEF.Repositories
{
    ...
    public partial class ALL_CONS_COLUMNSRepository : AbstractRepository<ALL_CONS_COLUMNS, IOraEntities>
    {
        private static ILog log = LogManager.GetLogger(typeof(ALL_CONS_COLUMNSRepository));
    	
    	// Empty Constructor for mocking purposes
    	public ALL_CONS_COLUMNSRepository()
    	{
    	}
