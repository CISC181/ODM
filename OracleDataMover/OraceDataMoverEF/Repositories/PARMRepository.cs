...
namespace OracleDataMoverEF.Repositories
{
    ...
    public partial class PARMRepository : AbstractRepository<PARM, IODMEntities>
    {
        private static ILog log = LogManager.GetLogger(typeof(PARMRepository));
    	
    	// Empty Constructor for mocking purposes
    	public PARMRepository()
    	{
    	}
    
    	public PARMRepository(ODMDataContext context)
                : base(context)
    	{
    	}
