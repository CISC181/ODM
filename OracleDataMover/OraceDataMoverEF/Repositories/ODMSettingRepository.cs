...
namespace OracleDataMoverEF.Repositories
{
    ...
    public partial class ODMSettingRepository : AbstractRepository<ODMSetting, IODMEntities>
    {
        private static ILog log = LogManager.GetLogger(typeof(ODMSettingRepository));
    	
    	// Empty Constructor for mocking purposes
    	public ODMSettingRepository()
    	{
    	}
    
    	public ODMSettingRepository(ODMDataContext context)
                : base(context)
    	{
    	}
